...
v8Function SurfaceToImage(V8ARGS){
	...
	SDL_Surface *surface = static_cast<SDL_Surface*>(v8::Local<v8::External>::Cast(self->GetInternalField(0))->Value());
...
v8Function SurfaceClone(V8ARGS){
    BEGIN_OBJECT_WRAP_CODE;
    v8::Local<v8::Object> self = args.Holder();
	SDL_Surface *srcsurface = static_cast<SDL_Surface*>(v8::Local<v8::External>::Cast(self->GetInternalField(0))->Value());
...
v8Function SurfaceGetPixel(V8ARGS){
    ...
    v8::Local<v8::Object> self = args.Holder();
    SDL_Surface *surface = static_cast<SDL_Surface*>(v8::Local<v8::External>::Cast(self->GetInternalField(0))->Value());
    int *pixels = static_cast<int*>(static_cast<SDL_Surface*>(v8::Local<v8::External>::Cast(self->GetInternalField(0))->Value())->pixels);
