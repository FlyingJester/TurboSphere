...
functionArray GetFunctions(){
    ...
    funcs[numerate(false)]=IsKeyPressedPointer;
    funcs[numerate(false)]=IsAnyKeyPressedPointer;
    funcs[numerate(false)]=GetKeyPointer;
    funcs[numerate(false)]=AreKeysLeftPointer;
