	...
	*/
	...
	while(!IsKeyPressed(KEY_Q)){
			if(IsKeyPressed(KEY_Y))
				Abort("Isn't the abort function cool?");
		...
		fonty2.drawText(32+GetScreenWidth()/2, 20, "The local host name is:");
		fonty2.drawText(32+GetScreenWidth()/2, 30, GetLocalName());
	...
	while(!IsKeyPressed(KEY_ESCAPE)){
		...
		far.drawText(10, 70, "Aptiva? We drew 10,000 frames in "+z+" milliseconds. Good? You be the judge.");
